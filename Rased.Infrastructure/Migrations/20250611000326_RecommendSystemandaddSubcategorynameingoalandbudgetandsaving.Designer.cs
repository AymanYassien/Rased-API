...
namespace Rased.Infrastructure.Migrations
{
    ...
    [Migration("20250611000326_RecommendSystemandaddSubcategorynameingoalandbudgetandsaving")]
    partial class RecommendSystemandaddSubcategorynameingoalandbudgetandsaving
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rased.Infrastructure.Models.Recomm.BudgetRecommendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WalletGroupId");

                    b.HasIndex("WalletId");

                    b.ToTable("BudgetRecommendation");
                });
            ...
            modelBuilder.Entity("Rased.Infrastructure.Models.Recomm.BudgetRecommendation", b =>
                {
                    ...
                    b.HasOne("Rased.Infrastructure.Models.SharedWallets.SharedWallet", "WalletGroup")
                        .WithMany()
                        .HasForeignKey("WalletGroupId")
                        .OnDelete(DeleteBehavior.Cascade);
